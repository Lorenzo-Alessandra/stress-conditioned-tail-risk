...
def main() -> None:
    ...
    backtest_results.to_parquet(
        paths_config["processed_files"]["var_backtesting_baseline"]
    )

    violations.to_parquet(
        paths_config["processed_files"]["var_violations_baseline"]
    )
    ...
    csv_path = "outputs/tables/var_backtesting_baseline.csv"
    latex_path = "outputs/tables/var_backtesting_baseline.tex"
    ...
    print("\nBacktesting outputs saved successfully.")
    print(f"Backtesting parquet: {paths_config['processed_files']['var_backtesting_baseline']}")
    print(f"Violation parquet: {paths_config['processed_files']['var_violations_baseline']}")
