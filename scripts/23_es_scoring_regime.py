...
def main() -> None:
    ...
    conditional_es_path = paths_config["processed_files"]["conditional_es_regime"]
    ...
    print("Reading regime-specific conditional ES forecasts...")
    ...
    scored.to_parquet(paths_config["processed_files"]["es_scores_daily_regime"])
    summary.to_parquet(paths_config["processed_files"]["es_scoring_regime"])
    ...
    csv_path = "outputs/tables/es_scoring_regime.csv"
    latex_path = "outputs/tables/es_scoring_regime.tex"
    ...
    print("\nRegime-specific ES scoring outputs saved successfully.")
    print(f"Daily ES scores: {paths_config['processed_files']['es_scores_daily_regime']}")
    print(f"ES summary: {paths_config['processed_files']['es_scoring_regime']}")
